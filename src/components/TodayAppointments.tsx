...
import { Clock, User, PawPrint, DollarSign, FileText } from 'lucide-react';
...
export const TodayAppointments = () => {
  const { appointments, loading, error, count } = useTodayAppointments();
  ...
  return (
    <Card className="border-primary/20">
      <CardHeader>
        ...
        <CardDescription>
          {nextAppointment 
            ? `Próximo: ${nextAppointment.appointment_time} - ${nextAppointment.pet.name}`
            : count > 0 
